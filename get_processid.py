...
zk_process_id_path = "/nonzc/mms/merge/balprov"
zk_config_node = "/nonzc/mms/merge/mms_pick.ini"
...
out = subprocess.Popen(["python", "./complex_merge.py ", "-c", local_config_name], stdout=subprocess.PIPE)
